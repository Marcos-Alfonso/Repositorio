 ...
 * Implementa la clase Almacen que se utilizará para almacenar los elementos
   ...
   Esto lo podríamos conseguir marcandolos como synchronized, aunque en este caso
   como estamos con semaforos, lo realizaremos utilizando un semaforo de tipo
   "mutex", semaforo binario, donde el semaforo vale 0 (bloquea) o 1 (libre)

    MutEx ==> Mutual Exclusion

    Véase: https://www.geeksforgeeks.org/mutex-vs-semaphore/
 ...
 * @author santiago
 */
public class Almacen extends ej15_prod_cons_semaforo.Almacen {
    ...
    public void guarda(int item) throws InterruptedException {
        //
        mutex.acquire(1); // INCIO EXCLUSION MUTUA
        //
        ...
        //
        mutex.acquire(1); // FIN EXCLUSION MUTUA
        //
