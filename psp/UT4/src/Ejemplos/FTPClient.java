 ...
 * FTP Client
   ...
   https://github.com/nscepanovic/ftp-client
   * 
   Aplicación que a través de menús implementa la funcionalidad de un cliente
   FTP
   Desde este ejemplo podéis observar como utilizando sockets se puede implementar
   el protocolo FTP de la capa de aplicación definido en RFC 959
   
   https://www.rfc-es.org/rfc/rfc0959-es.txt
   https://tools.ietf.org/html/rfc959
   * 
   * Si tenemos que hacer aplicaciones que usen el protocolo FTP es preferible
   * utilizar librerias que lo implementen como  Apache commons si las tenemos
   * disponibles
 */
